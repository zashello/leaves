...
static const uint8_t font6x8[][FONT_W] = {
...
esp_err_t ssd1309Init(const ssd1309_config_t *config)
{
  ...
  // SSD1309初始化序列 (2.42寸, 128x64)
  ssd1309WriteCommand2(0xFD, 0x12);  // 解锁命令 (SSD1309特有)
  ...
  ssd1309WriteCommand(0xA1);         // 段重映射
  ssd1309WriteCommand(0xC8);         // COM扫描方向
  ssd1309WriteCommand2(0xDA, 0x12);  // COM引脚配置
  ssd1309WriteCommand2(0x81, 0x7F);  // 对比度
  ssd1309WriteCommand2(0xD9, 0x82);  // 预充电
...
void ssd1309Write(char c)
{
  ...
  const uint8_t *charData = font6x8[c - 32];
